  ...
  context 'gem' do
    ...
    context 'with value types' do
      should 'generate appropriate asserts' do
        hash_all = { n: nil, t: true, f: false, d: Date.new(2019,1,1), dt: DateTime.new(2018,3,1,17,0,0) }
        ...
        AssertGenerator::Klass.any_instance.expects(:out).with("assert_equal Date.new(2019, 1, 1), hash_all[:d]").once
        AssertGenerator::Klass.any_instance.expects(:out).with("assert_equal DateTime.new(2018, 3, 1, 17, 0, 0, '+00:00'), hash_all[:dt]").once
